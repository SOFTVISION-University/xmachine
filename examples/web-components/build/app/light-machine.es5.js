...
App.loadBundle('light-machine', ['exports'], function (exports) {
    var h = window.App.h;
    var STATE_DELIMITER = '.';
    ...
    var lightMachine = Machine$1(lightMachineStateChart);
    var machine = function (statechart) {
            ...
            return /** @class */ (function (_super) {
                ...
                function class_1() {
                    ...
                    for (var _d = 0; _d < arguments.length; _d++) {
                        _args[_d] = arguments[_d];
                    }
                    var _this = _super.call(this) || this;
                    _this.fsm = statechart instanceof Machine$1 ? statechart : Machine$1(statechart);
                    _this.currentState = _this.fsm.initialState.value;
                    _this.transition = function (event, eventValue) {
                        var newState = _this.fsm.transition(_this.currentState, event, eventValue);
                        _this.currentState = newState.value;
                        _this.runActions(newState, eventValue);
                    };
                    _this.runActions(_this.fsm.initialState, {});
                    return _this;
                }
                class_1.prototype.getMachine = function () {
                    return this.fsm;
                };
                class_1.prototype.runActions = function (state, eventValue) {
                    var _this = this;
                    var actions$$1 = state.actions;
                    actions$$1.forEach(function (action) {
                        var actionFn = _this[action];
    ...
    var State_1 = createCommonjsModule(function (module, exports) {
        ...
        var State = /** @class */ (function () {
            ...
            events) {
                ...
                if (activities === void 0) {
                    activities = constants_1$1.EMPTY_ACTIVITY_MAP;
                }
                if (data === void 0) {
                    data = {};
                }
    ...
    var lightContainerStyle = {
        display: 'flex'
    };
    exports.LightMachine = /** @class */ (function () {
        function LightMachine() {
            ...
            this.count = function () {
                _this.transition('timer');
            };
        }
        LightMachine.prototype.componentDidLoad = function () {
            this.startCountdown();
        };
        LightMachine.prototype.componentDidUnload = function () {
            clearInterval(this.interval);
        };
        LightMachine.prototype.startCountdown = function () {
            this.interval = window.setInterval(this.count, 10000);
        };
        LightMachine.prototype.render = function () {
            var newLightStyle = Object.assign({}, lightStyle, { 'background-color': this.color });
            return (h("div", { style: lightContainerStyle }, h("span", { style: newLightStyle })));
        };
        Object.defineProperty(LightMachine, "is", {
            get: function () { return "light-machine"; },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(LightMachine, "properties", {
            get: function () {
                return {
                    "color": {
                        "state": true
    ...
    exports.LightMachine = __decorate([
        machine(lightMachine)
    ], exports.LightMachine);
    Object.defineProperty(exports, '__esModule', { value: true });
});
